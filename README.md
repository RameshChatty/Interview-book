# Senior Java Developer Interview Guide (5-8 Years Experience)

This comprehensive guide is designed for conducting technical interviews with Senior Java developers having 5-8 years of experience. Each chapter contains in-depth questions with detailed answers covering essential topics.

## Table of Contents

1. [Core Java Fundamentals](#chapter-1-core-java-fundamentals)
2. [Memory Management & Garbage Collection](#chapter-2-memory-management--garbage-collection)
3. [Collections Framework](#chapter-3-collections-framework)
4. [Java 8-25 Features](#chapter-4-java-8-25-features)
5. [Multi-threading & Concurrency](#chapter-5-multi-threading--concurrency)
6. [Kafka & Event Streaming](#chapter-6-kafka--event-streaming)
7. [Spring Boot & Microservices](#chapter-7-spring-boot--microservices)
8. [Java Coding Questions](#chapter-8-java-coding-questions)
...
1. Each chapter contains real-world interview questions
2. Detailed answers with code examples where applicable
3. Follow-up questions to assess deeper understanding
4. Tips for evaluating candidate responses
5. Time estimates for each question

**Estimated total interview time: 3-4 hours (can be split into multiple rounds)**

---

## Navigation

- [Chapter 1: Core Java Fundamentals](./Chapter1_CoreJava.md)
- [Chapter 2: Memory Management](./Chapter2_MemoryManagement.md)
- [Chapter 3: Collections Framework](./Chapter3_Collections.md)
- [Chapter 4: Java 8-25 Features](./Chapter4_Java8-25Features.md)
- [Chapter 5: Multi-threading](./Chapter5_MultiThreading.md)
- [Chapter 6: Kafka](./Chapter6_Kafka.md)
- [Chapter 7: Spring Boot & Microservices](./Chapter7_SpringBoot.md)
- [Chapter 8: Java Coding Questions](./Chapter8_CodingQuestions.md)
